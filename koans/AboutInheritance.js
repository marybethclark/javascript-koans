 //I hope these are correct.  I filled them all out before having the website check them, which it didn't seem to do.  It just jumped straight to "Thinking About Applying What We Have Learnt". 
...
describe("About inheritance", function() {
  ...
  it("should be able to call a method on the base object", function() {
    expect(this.swedishChef.answerNanny()).toEqual("Mmmm soup!""Everything's cool!");
  });
